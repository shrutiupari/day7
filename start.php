	...
	<div class="introduction" id="indro">
		<div class="container">
			...
			<div class="introduction-info">
				<p>An event is something that happens, not just exists-somebody has to make it happen. So we welcome you all here for the biggest events that are going to be held in the upcoming days. </p>
			</div>
		</div>
	</div>
	<!-- //introduction -->
				...
				<div class="about-grids">
					<div class="col-md-6 about-grid">
						...
						<div class="col-xs-9 about-grid-right">
							<h4>AISSEL TECHNOLOGIES PVT LTD </h4>
							<h2>Our Company </h2>
<p> Aissel is a Software Technology Solutions and Business Research company specializing in healthcare Thought Leader analytics.<br>
Our enterprise-class software solutions cater to the business intelligence needs of industry leading Pharmaceutical, Biotech and Medical Devices companies.<br>
								KOL Management Suite is our flagship product that enables our customers to integrate, manage and monitor their KOL development and engagement initiatives.<br>
								Our software solutions are built on robust technology platforms and can be integrated with existing enterprise-wide applications.  <br>
Our content research services and methodologies complement our software solutions and enable us to help strengthen the information and analytics needed by our customers.<br>
							<p>With an integrated delivery platform, we render data with unparalleled accuracy and the insights with unmatched clarity.
							<p> <b> <i> Hence we say, it is Business Intelligence… Ready! </b> </i> </p>
						</div>
...
?>
			...
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						...
						<li role="presentation"><a href="#event" role="tab" id="learning-tab" data-toggle="tab" aria-controls="learning">Concert</a></li>
						<li role="presentation"><a href="#playing" role="tab" id="playing-tab" data-toggle="tab" aria-controls="playing">Drama</a></li>
						<li role="presentation"><a href="#painting" role="tab" id="painting-tab" data-toggle="tab" aria-controls="painting">Product Launch </a></li>
						<li role="presentation"><a href="#school" role="tab" id="school-tab" data-toggle="tab" aria-controls="school">Trekking</a></li>
					</ul>
							...
							<div class="w3_tab_img">
								<div class="col-sm-3 w3_tab_img_left">
									<div class="demo">
										<a class="cm-overlay" href="images/g1.jpg">
										  <figure class="imghvr-shutter-in-out-diag-2">	<img src="<?php echo $row['e_banner'];?>" width="175" height="200" class="img-responsive" />
										  </figure>
										</a>
									</div>
									<div class="agile-gallery-info">
										<h5>Concert By Famous Singers</h5>
										<button type="submit"> <a href ="log.php"> Book Tickets </a></button>
								...
								<div class="col-sm-3 w3_tab_img_left">
									<div class="demo">
										  ...
										  <figure class="imghvr-shutter-in-out-diag-2"><img src="<?php echo $row['e_banner'];?>"class="img-responsive" />
										  </figure>
	...
	<div class="contact" id="mail">
		Please fill free to contact us on our website </div>
			...
			<div class="address-grids">
				<div class="address-grid">
					...
					<div class="address-info">
						<p>Aissel Technologies Pvt Ltd</p>
                                                <p>Block A, Floor II, IT Park,</p>
						<p>Deshpande Nagar Hubbali <br>
								</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				...
				<div class="address-grid">
					...
					<div class="address-info">
						<p><a href="mailto:example@email.com">sales@aissel.com</a></p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
